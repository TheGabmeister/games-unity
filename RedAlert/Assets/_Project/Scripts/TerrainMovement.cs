public static class TerrainMovement
{
    ...
    {
        //           Foot  Tracked Wheeled Float  Fly
        /* Clear */ { 0.9f, 0.8f,  0.6f,   0f,   1.0f },
        /* Road  */ { 1.0f, 1.0f,  1.0f,   0f,   1.0f },
        /* Rough */ { 0.8f, 0.7f,  0.4f,   0f,   1.0f },
        /* Sand  */ { 0.8f, 0.7f,  0.4f,   0f,   1.0f },
        /* Water */ { 0f,   0f,    0f,     1.0f,  1.0f },
        /* Ore   */ { 0.9f, 0.7f,  0.5f,   0f,   1.0f },
        /* Gems  */ { 0.9f, 0.7f,  0.5f,   0f,   1.0f },
    };
