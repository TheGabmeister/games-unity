...
- **Newtonsoft JSON** for save system serialization (supports Dictionary, HashSet, polymorphism that JsonUtility cannot).
...
├── Data/{Classes,Enemies,Items,Equipment,Spells,Encounters,Maps,Shops}/
├── Scenes/
├── Prefabs/
...
- Debug overlay (F1) and debug console (backtick) available in play mode — see SPEC.md Phase 1
